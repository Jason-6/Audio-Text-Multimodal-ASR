...
class Runner():
    ...
    def set_model(self):
        ...
        self.model = RobertaM2Model(self.acoustic_config)
        self.model.cuda()
        self.model.train()
    ...
    def train(self,):
        ...
        while self.global_step <= self.total_steps:
            ...
            loss_val, acoustic_loss_val = 0, 0
            for batch in progress:
                batch_is_valid, acoustic_batch = batch
                try:
                    ...
                    acoustic_loss, _= self.model(a_inputs=a_inputs,a_attention_mask=a_attention_mask,a_labels=a_labels,a_mask_labels=a_mask_labels)
                    ...
                    if (self.total_steps+1) % self.gradient_accumulation_steps == 0:
                        ...
                        progress.set_description("Loss {:.4f} - Spec Loss {:.4f} ".format(loss_val, acoustic_loss_val))
