...
class MultiModalDataset(BaseDataset):
    def __init__(self, file_path, sets, bucket_size, max_timestep=0, drop=False, 
                 acoustic_config=None, tokenizer=None, mask_proportion=0.15):
        ...
        for x_a, x_len in zip(X_a, X_lens):
    ...
    def process_x_pad_batch(self, x_a_pad_batch):
    ...
    def __getitem__(self, index):
        ...
        return self.process_x_pad_batch(x_a_pad_batch)
