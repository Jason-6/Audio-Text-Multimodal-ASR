...
def run(args, config, train_data, valid_data):
    ...
    valid_log_file = '/vol/nfs/mgl/GST/3_31_ctaL/CTAL-main/Ablation_Study_AISHELL_Pretrained/without_MLM/decode_log'
        ...
        for acoustic_inputs, semantic_inputs, label_inputs, _, label_len, audio_lens, text_lens in train_loader:
            ...
            if (step == 1) or (step % valid_step == 0):
                ...
                if avg_cer < min_cer:
                    min_cer = avg_cer
                    # 保存当前最佳模型参数到文件中
                    ckppdir = '/vol/nfs/mgl/GST/3_31_ctaL/CTAL-main/Ablation_Study_AISHELL_Pretrained/without_MLM/result'
