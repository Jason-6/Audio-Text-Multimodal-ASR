...
SETS = ['/home/geshuting/test_preprocess']
#         'dev-other', 'test-clean', 'test-other'] # change these to match your dataset

# SETS = ['Session1', 'Session2', 'Session3', 'Session4', 'Session5'] # change these to match your dataset

# SETS = ['train', 'dev', 'test',] # change these to match your dataset

# SETS = ['dada-online','zhikang-online','qingqing-online','dahai-online','peiyou-online']
...
def get_preprocess_args():
    ...
    parser.add_argument('--data_root', default='./data/', type=str, help='Path to store output', required=False)
